...
const newsArticles = [
  { id: 1, title: "NVIDIA's Data Center Revenue Surges Past Expectations", source: "Reuters", time: "2h ago", summary: "NVIDIA reported record quarterly data center revenue driven by unprecedented AI chip demand. The company's H100 and upcoming B200 GPUs continue to see supply constraints as hyperscalers race to build AI infrastructure.", tickers: ["NVDA", "MSFT", "GOOGL"], sentiment: "bullish" as const },
  { id: 2, title: "TSMC Expands Advanced Packaging Capacity for AI Chips", source: "Nikkei Asia", time: "4h ago", summary: "Taiwan Semiconductor Manufacturing Co. is investing $5B to triple its CoWoS advanced packaging capacity, a critical bottleneck in AI chip production that has limited supply of NVIDIA and AMD processors.", tickers: ["TSM", "NVDA", "AMD"], sentiment: "bullish" as const },
  { id: 3, title: "ASML Faces Headwinds from Tightening China Export Controls", source: "Financial Times", time: "5h ago", summary: "The Dutch lithography equipment maker warned investors that expanded U.S. restrictions on semiconductor exports to China could reduce 2025 revenue by up to 10%, impacting its EUV machine orders.", tickers: ["ASML"], sentiment: "bearish" as const },
  { id: 4, title: "Samsung and SK Hynix Battle for HBM Market Dominance", source: "Bloomberg", time: "7h ago", summary: "The race to supply High Bandwidth Memory chips for AI accelerators intensifies as Samsung ramps HBM3E production to challenge SK Hynix's market lead. Both companies are investing billions in next-gen HBM4.", tickers: ["SSNLF", "SKHYY"], sentiment: "neutral" as const },
  { id: 5, title: "AMD MI350 Benchmarks Show Competitive Performance vs NVIDIA", source: "Tom's Hardware", time: "9h ago", summary: "Early benchmarks of AMD's MI350 AI accelerator show promising results in inference workloads, potentially offering a more cost-effective alternative to NVIDIA's H100 for certain enterprise use cases.", tickers: ["AMD", "NVDA"], sentiment: "bullish" as const },
  { id: 6, title: "Intel Delays Ohio Fab as Foundry Business Restructures", source: "Wall Street Journal", time: "12h ago", summary: "Intel is pushing back the timeline for its $20B Ohio fabrication plant by at least a year as it reassesses its foundry strategy and focuses on improving yields at existing facilities.", tickers: ["INTC"], sentiment: "bearish" as const },
  { id: 7, title: "Broadcom's AI Networking Revenue Jumps 220% YoY", source: "CNBC", time: "14h ago", summary: "Broadcom reported explosive growth in its AI-related networking and custom ASIC business, driven by demand from hyperscale customers building out AI data center infrastructure.", tickers: ["AVGO"], sentiment: "bullish" as const },
];

const insiderTrades = [
  { id: 1, company: "NVDA", insider: "Jensen Huang", title: "CEO", type: "sell" as const, shares: 120_000, price: 878.5, date: "Feb 24" },
  { id: 2, company: "AMD", insider: "Lisa Su", title: "CEO", type: "sell" as const, shares: 40_000, price: 172.3, date: "Feb 23" },
  { id: 3, company: "AVGO", insider: "Hock Tan", title: "CEO", type: "sell" as const, shares: 25_000, price: 1680.0, date: "Feb 22" },
  { id: 4, company: "TSM", insider: "C.C. Wei", title: "CEO", type: "buy" as const, shares: 50_000, price: 168.4, date: "Feb 22" },
  { id: 5, company: "INTC", insider: "Pat Gelsinger", title: "Former CEO", type: "sell" as const, shares: 200_000, price: 21.5, date: "Feb 21" },
  { id: 6, company: "MSFT", insider: "Satya Nadella", title: "CEO", type: "sell" as const, shares: 10_000, price: 410.2, date: "Feb 20" },
  { id: 7, company: "ASML", insider: "Peter Wennink", title: "Former CEO", type: "sell" as const, shares: 5_000, price: 920.0, date: "Feb 19" },
  { id: 8, company: "ARM", insider: "Rene Haas", title: "CEO", type: "sell" as const, shares: 30_000, price: 152.0, date: "Feb 19" },
  { id: 9, company: "MRVL", insider: "Matt Murphy", title: "CEO", type: "buy" as const, shares: 15_000, price: 78.3, date: "Feb 18" },
      ...
      <div className="flex gap-0 min-h-[calc(100vh-7.5rem)]">
        ...
        <div className="w-[70%] border-r border-border p-6 space-y-4 overflow-y-auto">
          ...
          {newsArticles.map((article) => {
            ...
            return (
              <Card key={article.id} className="group cursor-pointer transition-colors hover:bg-card/80 border-border/50">
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      ...
                      <div className="flex items-center gap-1.5 pt-1">
                        {article.tickers.map((t) => (
                          <Badge key={t} variant="outline" className="text-[10px] font-mono px-1.5 py-0 border-border/50 text-foreground/60">{t}</Badge>
                        ))}
                      </div>
                    </div>
